# Run Mocha Parallel Tests on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Mocha Parallel Tests across real browsers and operating systems.
